...
public class StudentDataBase {
    ...
    public static List<Student> getAllStudents(){
         ...
         * 4th grade students
         */
        Student student5 = new Student("Sophia",1,3.5,"female",10, Arrays.asList("swimming", "dancing","football"));
        Student student6 = new Student("James",4,3.9,"male", 22,Arrays.asList("swimming", "basketball","baseball","football"));
        Student student7 = new Student("Aswin",1,3.9,"male", 22,Arrays.asList("volleyball", "cricket"));
        Student student8 = new Student("Suresh",2,3.9,"male", 22,Collections.<String>emptyList());
